...
> **CC-Switch 用户特别提醒**：如果你使用 [CC-Switch](https://github.com/samllma/cc-switch) 并开启了[路由服务](https://www.ccswitch.io/zh/docs?section=proxy&item=service)，可以将 `llm.url` 配置成 CC-Switch 启动的代理地址，无需额外配置：
